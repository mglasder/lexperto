...
def create_mock_decision() -> CourtDecisionStructured:
    ...
    entscheid_section = SectionStructured(
        ...
        content=[
            ...
            Paragraph(
                number="2.", text="Die Kosten werden dem Beschwerdeführer auferlegt."
            ),
        ],
        is_structured=True,
    )
    ...
    decision = CourtDecisionStructured(
        meta=meta, content=[entscheid_section, erwägungen_section, sachverhalt_section]
    )
...
def create_minimal_decision_yaml(path: str):
    ...
    section = Section(
        name="entscheid",
        content=[Paragraph(number="1.", text="Dies ist ein Testparagraph.")],
    )
